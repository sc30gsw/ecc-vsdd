...
- Set the candidate version consistently to the current release candidate (`1.0.0-rc.3` after the RC2 installed-subagent hook fix).
...
Promote `v1.0.0-rc.3` to `v1.0.0` only when the same commit and installed payload have passed all gates.
