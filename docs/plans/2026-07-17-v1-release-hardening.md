...
- Set the candidate version consistently to the current release candidate (`1.0.0-rc.12` after completing the official-doc lifecycle audit).
...
Promote `v1.0.0-rc.12` to `v1.0.0` only when the same commit and installed payload have passed the Review-boundary release gates.
