...
- Set the candidate version consistently to the current release candidate (`1.0.0-rc.8` after synchronizing the protected project-agent hook schema with bootstrap).
...
Promote `v1.0.0-rc.8` to `v1.0.0` only when the same commit and installed payload have passed all gates.
