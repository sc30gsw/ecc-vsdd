...
- Set the candidate version consistently to `1.0.0-rc.1`.
...
Promote `v1.0.0-rc.1` to `v1.0.0` only when the same commit and installed payload have passed all gates.
